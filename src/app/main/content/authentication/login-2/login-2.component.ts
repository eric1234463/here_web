...
export class FuseLogin2Component {
    ...
    constructor(private fuseConfig: FuseConfigService, private formBuilder: FormBuilder, public router: Router, public snackBar: MatSnackBar, public userService: UserService) {
    ...
    login(provider) {
        this.userService.login(provider).then(user => {
            this.router.navigateByUrl('/qr');
        });
    }
